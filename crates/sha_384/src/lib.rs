...
//! SHA-384: the SHA-512 core with a different IV and the output truncated to the
//! first 48 bytes (6 of the 8 state words). Structured identically to `sha_256`,
//! but on 64-bit words: 128-byte blocks, 80 rounds, an 80-entry message schedule,
//! a 128-bit length field, and a `[u64; 80]` scratch array reused across calls.
//! The schedule and compression loops are partially unrolled 8 at a time via
...
/// A structure representing the SHA-384 hash algorithm.
pub struct Sha384 {
    w: [u64; 80],
    h0: u64,
    h1: u64,
...
impl Sha384 {
    /// Creates a new instance of the SHA-384 hash algorithm.
    pub fn new() -> Self {
        Self {
            w: [0; 80],
            h0: 0,
    ...
    /// Computes the SHA-384 digest of the given message.
    pub fn digest(&mut self, msg: &[u8]) -> [u8; 48] {
        self.h0 = 0xcbbb9d5dc1059ed8;
        self.h1 = 0x629a292a367cd507;
        self.h2 = 0x9159015a3070dd17;
        self.h3 = 0x152fecd8f70e5939;
        self.h4 = 0x67332667ffc00b31;
        self.h5 = 0x8eb44a8768581511;
        self.h6 = 0xdb0c2e0d64f98fa7;
        self.h7 = 0x47b5481dbefa4fa4;
        ...
        // SHA-384 emits the first 48 bytes (h0..h5).
        let mut hash = [0; 48];
...
mod tests {
    use super::*;
    use sha2::{Digest, Sha384 as Theirs};
    ...
    fn known_vectors() {
        ...
        assert_eq!(&empty[..4], &[0x38, 0xb0, 0x60, 0xa7]); // SHA-384("")
